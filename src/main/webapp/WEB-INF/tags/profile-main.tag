...
<div class="panel panel-primary">
	<a href="/edit"><img class="img-responsive photo" src="${pageContext.request.contextPath}/media/avatar/5ccbe647-256b-41c8-ad68-ecc77bb573e7.jpg" alt="photo"></a>
	<h1 class="text-center">
		<a style="color: black;" href="${pageContext.request.contextPath}/edit">${fullName}</a>
	</h1>
